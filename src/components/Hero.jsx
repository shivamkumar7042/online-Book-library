...
const Hero = ({ searchQuery }) => {
  ...
  const generatePageNumbers = () => [1, 2, 3, 4, 5, 6];
            ...
            return (
              ...
              >
                ...
                <div className="p-4 md:p-6">
                  {/* Changed aspect ratio from [2/3] to [3/4] below */}
                    ...
                    <div className="flex items-center mt-2 md:mt-3">
                      <div className="flex text-amber-400">
                        {[...Array(5)].map((_, i) => (
                          <StarIcon
                            key={i}
                            className={`h-4 w-4 md:h-5 md:w-5 ${i < Math.floor(book.rating) ? 'fill-current' : 'fill-gray-600'}`}
                          />
                        ))}
                      </div>
